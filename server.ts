...
<table>
  ...
  <tr><td>GET /gbp</td><td>FX-aware paid endpoint, GBP ($1.00 default; override with ?amount=N).</td><td><span class="badge paid">PAID E2E</span></td></tr>
</table>
...
app.get("/health", (_req, res) => {
  res.json({
    ...
    routes: [
      ...
      "GET /gbp          — Phase-1-only 402 challenge for GBP ($1.00 default; override with ?amount=N)",
    ],
  });
});
...
app.get("/gbp", makeMatrixHandler("GBP"));
